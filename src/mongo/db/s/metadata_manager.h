...
public:
     ...
     * those queries.
     */
    auto overlappingMetadata(std::shared_ptr<MetadataManager> itself, ChunkRange const& range)
...
private:
    ...
    friend auto MetadataManager::overlappingMetadata(std::shared_ptr<MetadataManager> itself,
