...
void CollectionShardingState::_onConfigRefreshCompleteInvalidateCachedMetadataAndNotify(
    ...
    fassertStatusOK(
        40477, bsonExtractStringField(query, ShardCollectionType::id.name(), &refreshCollection));
...
void CollectionShardingState::_onConfigDeleteInvalidateCachedMetadataAndNotify(
    ...
    fassertStatusOK(
        40479, bsonExtractStringField(query, ShardCollectionType::id.name(), &deletedCollection));
